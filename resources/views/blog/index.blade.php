    ...
    <div class="container mx-auto p-4">
        <div class="p-4 lg:px-24">
            <div class="sm:bg-rmWhite sm:shadow sm:rounded-md sm:p-8">
                <div class="mt-4">
                    <div class="xl:px-20">
                        <h1 class="m:pt-2 text-rmTeal font-bebas sm:text-9xl text-6xl">Hello World!</h1>
                        <h2 class="text-rmBlue-dark text-2xl font-bebas">Friday 15th October 2021</h2>
                        <h3 class="mb-4 text-rmBlue-light font-bebas">By Rheanne McIntosh</h3>
                        <div>
                            <p class="mb-4">
                                Hello everyone! This is going to be a quick introductory blog post for me to get used
